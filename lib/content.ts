...
export const currently = {
  ...
  workingOn: "Full-stack engineer at QwamPay & Motoka",
...
export const experience: Role[] = [
  {
    ...
    org: "QWAM Technologies",
    period: "2025 – Present",
    context: "WhatsApp-native fintech · Lagos",
    href: "https://www.qwamtechnologies.com",
    live: true,
    points: [
      "Built three production frontends for QwamPay (marketing, support, admin) plus the parent company site at qwamtechnologies.com, the public home for QwamPay, QwamCare, and QwamAI.",
  ...
  },
  {
    ...
    points: [
      "Delivered around ten client projects end to end, from requirements and client meetings through to launch, including Truekey Realty and Who's Cuh?.",
...
export const work: CaseStudy[] = [
  {
    ...
    index: "01",
    kind: "Fintech",
    name: "QwamPay & QWAM Technologies",
    year: "2025–26",
    role: ["Frontend", "Backend", "Product UI"],
    oneLiner:
      "Three production frontends for a WhatsApp-payments fintech: a marketing site that has to earn trust in one scroll, a support portal that keeps it, and the admin portal the team runs the business from. Plus the parent company site.",
    problem:
      "QwamPay lets people make instant payments inside WhatsApp. That's a new behaviour, which means the website does the explaining a bank branch normally would. It had to make that behaviour feel obvious and safe to a first-time visitor, and the support experience couldn't undercut the promise the moment something went wrong.",
    process:
    ...
    solution:
      "Built and shipped three frontends: a fast, responsive marketing site that walks a visitor from 'what is this' to 'get started' without a dead end; a support portal where finding the answer takes fewer taps than raising a ticket; and the internal admin portal the team operates on. Also worked the backend behind the WhatsApp payment flow and wired up Meta's WhatsApp Business message templates, plus a reusable component library the three surfaces share. Then designed and shipped the parent company site, qwamtechnologies.com, as the public home for QwamPay, QwamCare, and QwamAI.",
    outcome:
      "The marketing site and support portal are live at qwampay.com, the first thing every prospective user, partner, and investor meets. The platform itself is in closed beta with around 300 testers, run day to day through the admin portal I built. The company site is live at qwamtechnologies.com.",
    stack: ["React", "TypeScript", "Tailwind CSS", "Node.js"],
    links: [
      { label: "Visit qwampay.com", href: "https://qwampay.com" },
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Study Buddy landing page: Learn without limits. Track every step. Floating quiz and progress-dashboard mockups.",
    },
...
export const about = [
  ...
  "The Computing degree gave me the part of the craft that doesn't change: the structures underneath, the reasons systems behave the way they do. Freelance work gave me the part that does: clients, deadlines, the discipline of shipping something a real person will sit in front of.",
...
export const portrait = {
  src: "/about/pelumi.jpg",
  alt: "Pelumi Adewara at his desk",
} as const;
